...
cdef class Amalgamation (object):
    cdef:
        ...
        np.double_t border_overcoming_rev(self, np.double_t g, Amalgamation other, np.double_t PRECISION)

        void _amalgamate(self, np.intp_t size, np.intp_t clusters, dict energies)
