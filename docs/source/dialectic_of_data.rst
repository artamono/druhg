...
Граница и предел. :raw-math:`$$ K · D^2_r · \sqrt{min(N, N\')} $$`.
######################################################################
...
|     |LeftAma| |RightAma|
|      Стороны не могут считать чужие кластеры.
...
| Среди них уникальные, например, последовательность точек ............... у них выделяется тело и две крайние точки-выбросы.
...
.. figure:: ./pics/first/example_comparison.png
   ...
   Правый нижний угол: с помощью ДРУГа вы никогда не получите один большой кластер-датасет. Чтобы стать кластером, должно быть иное.
   
   Во всех примерах видны выбросы. Приклеить их можно с помощью параметра `fix_outliers`.  
